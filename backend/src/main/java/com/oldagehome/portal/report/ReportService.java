...
public interface ReportService {
    ...
    Page<Resident> getResidentsReport(String status, String keyword, LocalDate startDate, LocalDate endDate, Pageable pageable);

    Page<Donor> getDonorsReport(String status, String keyword, String donationType, Pageable pageable);

    Page<Donor> getDonationsReport(String paymentMethod, LocalDate startDate, LocalDate endDate, String donationType, Pageable pageable);
